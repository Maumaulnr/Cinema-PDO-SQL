...
class FilmController
{
    ...
    //     // movieTitle, ... sont obligatoire
    //     // si movieTitle, ... sont vide
    //     if($movieTitle && $movieReleaseFilm && $movieDuration && $movieSynopsys && $movieGrade == "") {
    //         $isFormValid = false;
    //         $errorMessages["movieTitle"] && $errorMessages["movieReleaseFilm"] && $errorMessages["movieDuration"] && $errorMessages["movieSynopsys"] && $errorMessages["movieGrade"] = "Ce champ est obligatoire";
    //     }

    //     // label ne doit pas dépasser 30 caractères
    //     if(strlen($movieTitle) > 30) {
    //         $isFormValid = false;
